...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('database/migrations/create_user_email_addresses_table.php.stub')) => rename($file, determineSeparator('./database/migrations/create_'.title_snake($packageSlugWithoutPrefix).'_table.php.stub')),
